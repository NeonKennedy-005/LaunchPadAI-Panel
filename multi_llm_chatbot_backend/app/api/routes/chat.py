...
from app.api.utils import get_or_create_session_for_request_async, load_chat_session_into_context
    ...
    async def _event_generator():
        try:
            ...
            if message.chat_session_id:
                ...
                elif len(session_manager.get_session(sid).messages) == 0:
                    # Cold start / new worker: hydrate from MongoDB before routing
                    loaded = await load_chat_session_into_context(
