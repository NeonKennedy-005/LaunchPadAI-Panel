...
const buildSteps = (config) => {
  ...
  return [
    ...
    {
      title: 'Career focus & setup',
      fields: [
        { key: 'cyber_role', label: 'Your career focus', type: 'select', options: ['Internship search', 'Full-time / entry-level', 'Both internship and FT', 'Career exploration', 'Return offer conversion', 'Industry switch / pivot', 'Graduate school path', 'Other'] },
        { key: 'organization_type', label: 'Primary search channel', type: 'select', options: ['Handshake', 'LinkedIn', 'Company career pages', 'Career fairs / campus recruiting', 'Referrals / alumni', 'Hybrid (multiple channels)'] },
      ],
    },
    {
      title: 'Targets & tools',
